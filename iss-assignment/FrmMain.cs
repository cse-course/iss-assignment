...
namespace iss_assignment
{
    public partial class FrmMain : Form
    {
        ...
        private void ShowAllToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (this.currentUser.IsLogin())
            {
                FrmUserManagerment user = new FrmUserManagerment(this.userManagementBLL, this.userManagementClassicBLL, this.privilegeBLL, this.currentUser)
                {
                    MdiParent = this
                };
                user.Show();
        ...
        private void Status(Boolean status)
        {
            ...
            this.revokeRoleToolStripMenuItem.Enabled = status;
        }
        ...
        private void RevokeRoleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FrmRevokeRolePrivilege role = new FrmRevokeRolePrivilege(this.privilegeBLL, this.currentUser)
            {
                MdiParent = this
            };
            role.Show();
